<template>
  <div class="wuye-bullet-wrapper" v-show="visible" :class="{'active': visible}">
    <!--<div class="next-page">下一页</div>-->
    <h3 class="title">智慧物业概况</h3>
...
export default {
  ...
  data() {
    return {
      imgSrc: require("@/assets/screen/wuye-info.png"),
      playFirst: true
    };
  },
  props: {
